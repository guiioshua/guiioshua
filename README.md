...
Sou um desenvolvedor com foco em construção de aplicações escaláveis, integração de sistemas e arquitetura de dados. Atualmente, curso Tecnologia em Banco de Dados na FATEC São José dos Campos  e atuo profissionalmente no ecossistema Microsoft Dynamics 365, onde desenvolvo soluções complexas em C#, personalizações front end, automações via Power Automate e integrações do CRM para consumo de APIs.
